...
{
    public partial class f416_bao_cao_kem_diem_danh : Form
    {
        public f416_bao_cao_kem_diem_danh()
        {
            InitializeComponent();
            format_controls();
        ...
        private void load_data_2_grid()
        {
            ...
            v_us.FillDuLieuBaoCaoKemDiemDanh(CIPConvert.ToDecimal(m_sle_lop.EditValue), v_ds, Convert.ToInt32(m_txt_buoi.EditValue));
