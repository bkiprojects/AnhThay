...
namespace BKI_QLTTQuocAnh.NghiepVu {
    public partial class F356_LAP_THUC_THU : Form {
        ...
        private bool is_null_so_phieu_thu() {
            if(m_sle_so_phieu_thu.Text == "" || m_sle_so_phieu_thu.EditValue == null) {
        ...
        private bool is_null_so_phieu() {
            if(m_txt_so_phieu.Text == "") {
                m_txt_so_phieu.BackColor = Color.Bisque;
                return true;
            }
            m_txt_so_phieu.BackColor = Color.White;
        ...
        private bool is_valid_ok() {
            if(is_null_so_phieu_thu() || is_null_so_phieu() || is_null_lop() || is_null_hv() || is_null_so_tien()) {
       ...
       private void load_ten_hs(){
        ...
        void F356_LAP_THUC_THU_Load(object sender, EventArgs e) {
            try {
                set_init_form_load();
            }
            catch(Exception v_e) {
